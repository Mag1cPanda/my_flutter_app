...
class _HomepageState extends State<Homepage> {
  ...
  void loadData_sys_get() async {
    ...
    var url = 'http://49.232.173.220:3001/data/getIndexRecommendList';
...
//    Uri(scheme: 'https', host: 'appbg.lcfarm.com', path: homeNoviceListUrl);
    ...
    // uri方法3
//    Uri uri =
//        Uri.parse('http://49.232.173.220:3001/data/getIndexRecommendList');
//    print('uri:\n $uri');
...
//    }
  ...
  void loadData_sys_post() async {
    print('------bbloadData_sys_post--------');

    HttpClient httpClient = new HttpClient();

    var url = bbBaseUrl + bbContext + getExamSubject + suffix;
    HttpClientRequest request = await httpClient.postUrl(Uri.parse(url));

    // 设置请求头
    request.headers.set('content-type', 'application/json');
    request.headers.set('App-Version', '78');

    Map jsonMap = {'cardno': '42100419920521421X'};
...
//    var uri = Uri.parse(njqbaseUrl + homeNoviceListUrl);
    var uri = Uri.parse('http://49.232.173.220:3001/data/getIndexRecommendList');
  ...
  void loadData_http_post() async {
    ...
    Map params = {'cardno': '42100419920521421X'};
